...
export class InsertInState1712683006254 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        queryRunner.query(`
            ...
            INSERT INTO state("id", "name", "uf") VALUES (4, 'Amapa', 'AP');
            INSERT INTO state("id", "name", "uf") VALUES (5, 'Bahia', 'BA');
            INSERT INTO state("id", "name", "uf") VALUES (6, 'Ceara', 'CE');
            INSERT INTO state("id", "name", "uf") VALUES (7, 'Distrito Federal', 'DF');
            INSERT INTO state("id", "name", "uf") VALUES (8, 'Espirito Santo', 'ES');
            INSERT INTO state("id", "name", "uf") VALUES (9, 'Goias', 'GO');
            INSERT INTO state("id", "name", "uf") VALUES (10, 'Maranhao', 'MA');
            ...
            INSERT INTO state("id", "name", "uf") VALUES (14, 'Para', 'PA');
            INSERT INTO state("id", "name", "uf") VALUES (15, 'Paraiba', 'PB');
            INSERT INTO state("id", "name", "uf") VALUES (16, 'Pernambuco', 'PE');
            INSERT INTO state("id", "name", "uf") VALUES (17, 'Piaui', 'PI');
            INSERT INTO state("id", "name", "uf") VALUES (18, 'Parana', 'PR');
            ...
            INSERT INTO state("id", "name", "uf") VALUES (26, 'Sao Paulo', 'SP');
